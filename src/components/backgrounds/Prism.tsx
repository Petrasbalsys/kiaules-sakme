...
const Prism = ({
  ...
  useEffect(() => {
    //console.log('Prism useEffect triggered');
    const container = containerRef.current;
    
    if (!container) {
      //console.log('Prism container is null, returning');
      return;
    }
    
    //console.log('Prism initializing WebGL...');
    ...
    try {
      ...
      //console.log('GL context obtained');
      ...
      //console.log('Canvas appended, starting render setup...');
      ...
      const resize = () => {
        ...
        //console.log('Prism resize:', { w, h }); // Debug log
      ...
      // Listen to window resize instead of container
      const onWindowResize = () => resize();
      window.addEventListener('resize', onWindowResize);
      
      // Remove the ResizeObserver since we're using window resize now
      ...
      //console.log('Prism fully initialized!');
  ...
  return <div className="relative inset-0" ref={containerRef} />;
};
